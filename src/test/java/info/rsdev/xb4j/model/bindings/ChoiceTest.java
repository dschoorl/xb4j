...
class ChoiceTest {
    ...
    void setup() {
        ...
        choice.addOption(new SimpleType(new QName("elem2"), IntegerConverter.INSTANCE, false), "value",
                new ContextInstanceOf(ObjectB.class));
    }

    @Test
    void testMarshallChoiceNoNamespaces() throws Exception {
    ...
    @Test
    void testUnmarshallChoiceNoNamespaces() throws Exception {
        // unmarshall first option
        ByteArrayInputStream stream = new ByteArrayInputStream("<elem1>test1</elem1>".getBytes());
        RecordAndPlaybackXMLStreamReader staxWriter = new RecordAndPlaybackXMLStreamReader(
        ...
        assertEquals(Integer.valueOf(84), contextObjectB.getValue());
    }

    @Test
    void testChoiceWithoutContentNorElementGeneratesNoOutput() {
        assertSame(OutputState.NO_OUTPUT, choice.generatesOutput(new JavaContext(null)));
    }

    @Test
    void testChoiceWithoutContentWithMandatoryElementGeneratesOutput() {
        choice = new Choice(new QName("mandatory"), false);
        assertSame(OutputState.HAS_OUTPUT, choice.generatesOutput(new JavaContext(null)));
    }

    @Test
    void testChoiceWithoutContentWithOptionalElementGeneratesNoOutput() {
    ...
    void ignoreMissingMandatoryChildrenWhenNilIsSetTrue() throws XMLStreamException {
        ...
        UnmarshallResult result = UnmarshallUtils.unmarshall(nillableChoice,
    ...
    void doNotwriteNillAttributeWhenNillableBindingEncountersAValue() throws Exception {
        ...
        assertThat(writer.toString()).and("<elem><option>some_name</option></elem>").areIdentical();
    }
}
