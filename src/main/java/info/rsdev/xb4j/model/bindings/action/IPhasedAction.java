...
/**
 * Extension point that allows users of this framework to manipulate the java context, at specified points in the marshalling
 * or unmarshalling phase. This allows the user E.g. to set values in the Java domain that have no counterpart in the xml domain, 
 * or who's value is a derived value etc.  
 * 
 * @author Dave Schoorl
 */
public interface IPhasedAction {
	...
	public static enum ExecutionPhase {
		...
		/**
		 * Execute directly after creation of the object for the {@link IBinding} that this action is set on. It depends on
		 * the binding configuration if an object must be created that will be passed on in the unmarshall process or not.
		 * The JavaContext contains the nely created context object or null if no context object was created.
		 */
