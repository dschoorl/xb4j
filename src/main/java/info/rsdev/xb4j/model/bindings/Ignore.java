...
/**
 * This binding type allows you to swallow an element (tree) in the xml stream. The containing element tags are recognized and the
 * entire tree (if any) is ignored. This class supports repeated elements.
 *
 * @author dschoorl
 */
public class Ignore implements IBinding {
    ...
    public UnmarshallResult toJava(RecordAndPlaybackXMLStreamReader staxReader, JavaContext javaContext) throws XMLStreamException {
        ...
        return UnmarshallResult.VOID_RESULT;
    }
