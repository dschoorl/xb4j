...
public class IntegerConverter implements IValueConverter {
    ...
    /**
     * Create a new {@link IntegerConverter} that performs validation on the Integer. If you don't need validation, please use the
    ...
    /**
     * Create a new {@link IntegerConverter} with a specific {@link IValidator} and a minimum required length. When converting xml
     * to Object, a {@link ValidationException} is thrown when the length is shorter than minLength. When converting an
    ...
    public static final class RangeValidator implements IValidator {
        ...
        public <T> T isValid(T instance) throws ValidationException {
            ...
            if ((value < lowerBound) || (value > upperBound)) {
                throw new ValidationException(String.format("Integer must be between %d and %d: %d", lowerBound, upperBound, value));
            }
            return instance;
        }
