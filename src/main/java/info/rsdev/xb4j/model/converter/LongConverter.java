...
public class LongConverter implements IValueConverter {
    ...
    /**
     * Create a new {@link LongConverter} that performs validation on the Integer. If you don't need validation, please use the
    ...
    public static final class RangeValidator implements IValidator {
        ...
        public <T> T isValid(T instance) throws ValidationException {
            ...
            if ((value < lowerBound) || (value > upperBound)) {
                throw new ValidationException(String.format("Long must be between %d and %d: %d", lowerBound, upperBound, value));
            }
            return instance;
        }
